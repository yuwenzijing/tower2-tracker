  ...
  function injectModal() {
    ...
    overlay.innerHTML =
      '<div class="capture-box">' +
        ...
        '<a class="capture-download" id="captureDownload" href="https://github.com/yuwenzijing/tower2-tracker/releases/download/v1.3.3/BuyaliCollector-v1.3.3.zip" target="_blank" rel="noopener">下载 Windows 数据采集助手 V1.3.3</a>' +
    ...
    if (location.hostname === 'test.buyali.xyz') {
      ...
      testDownload.textContent = 'V1.3.3 测试包仅提供本地测试';
  ...
  async function createPairingCode() {
    ...
    try {
      ...
      var response = await fetch(API + '/pair', {
        ...
        body: JSON.stringify({ client: location.hostname === 'test.buyali.xyz' ? 'web-v1.3.3-test' : 'web-v1.3.3' })
      });
